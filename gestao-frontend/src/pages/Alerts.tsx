    ...
    try {
      const payload = {
        ...
        data_acao: form.data_acao
          ? new Date(form.data_acao).toISOString()
          : null
      }
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {alerts.map((a) => (
            ...
            >
              <div
                className={`p-2 rounded-lg ${a.tipo ? tipoColors[a.tipo] || "bg-gray-100" : "bg-gray-100"}`}
              >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {a.tipo && (
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs font-medium ${tipoColors[a.tipo] || ""}`}
                    >
                      {a.tipo}
                    </span>
                  )}
                ...
                {a.mensagem && (
                  <p className="text-sm text-gray-600 mt-1">{a.mensagem}</p>
                )}
                <div className="flex gap-3 mt-2 text-xs text-gray-400">
                  ...
                  {a.data_acao && (
                    <span>
                      Ação: {new Date(a.data_acao).toLocaleDateString("pt-BR")}
                    </span>
                  )}
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, profile_slug: e.target.value })
                  }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm({ ...form, data_acao: e.target.value })
                }
              />
            </div>
